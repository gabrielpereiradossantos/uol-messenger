...
class CPhOsipDebugInfo : public IOsipDebugInfo
{
public:
	CPhOsipDebugInfo(const char *pszFileName, const int iLineNumber, 
			const osip_trace_level_t uiLevel, const char *pszLogMessage);
	virtual ~CPhOsipDebugInfo();
	
protected:
	virtual CString GetFileName() const;
	virtual int GetLineNumber() const;
	virtual EnumOsipDebugLevel GetLogLevel() const;
...
private:
	...
	int					m_iLineNumber;
	EnumOsipDebugLevel	m_uiLogLevel;
