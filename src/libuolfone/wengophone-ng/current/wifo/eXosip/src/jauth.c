				     ...
				     osip_authorization_t **auth)
{
  ...
  /* <UOLFONE> */
  {
	char pszAuthCnonce[MAX_CNONCE_SIZE + 1] = { 0, }; 
	int nAuthCnonceLen = MAX_CNONCE_SIZE;

	if (0 == uolfone_auth_get_cnonce(passwd, pszAuthCnonce, &nAuthCnonceLen))
	{
		osip_authorization_set_cnonce(aut, osip_strdup(pszAuthCnonce));
	}
  }
  /* <UOLFONE/> */
					 ...
					 osip_proxy_authorization_t **auth)
{
  ...
  /* <UOLFONE> */
  {
	...
	if (0 == uolfone_auth_get_cnonce(passwd, pszAuthCnonce, &nAuthCnonceLen))
	{
		osip_proxy_authorization_set_cnonce(aut, osip_strdup(pszAuthCnonce));
	}
  }
  /* <UOLFONE/> */
