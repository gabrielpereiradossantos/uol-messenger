...
int eXosip_get_audio_ptime_from_call(eXosip_event_t* je, int jid, int source_id, int is_incomming_call);
int eXosip_get_media_formats_from_call(eXosip_event_t* je, int jid, int source_id, int is_incomming_call, osip_list_t *fmtp_attrib_list);
/* </UOLFONE> */
