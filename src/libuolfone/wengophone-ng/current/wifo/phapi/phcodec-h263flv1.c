...
int h263flv1_decode(void *ctx, const void *src, int srcsize, void *dst, int dstsize) {
	ph_h263_decoder_ctx_t * h263t = (ph_h263_decoder_ctx_t *) ctx;
	return phcodec_avcodec_decode(&h263t->decoder_ctx, src, srcsize,
				dst, dstsize);
}

int h263flv1_encode(void *ctx, const void *src, int srcsize, void *dst, int dstsize) {
...
void *h263flv1_encoder_init(void *ctx) {
...
void *h263flv1_decoder_init(void *ctx) {
	phvstream_t *s = (phvstream_t *)ctx;
...
void h263flv1_decoder_cleanup(void *ctx) {
