...
/* #undef HAVE_MACHINE_TYPES_H 1 */
/* #undef HAVE_SYS_INT_TYPES_H 1 */
...
/* #undef ERR_REPORTING_STDOUT 1 */

/* #undef ERR_REPORTING_SYSLOG (HAVE_SYSLOG_H & USE_SYSLOG) */
