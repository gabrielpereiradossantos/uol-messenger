...
class CShowAddCustomEmoticonDialogCommand : public IUOLMessengerCommand
{
public:
	CShowAddCustomEmoticonDialogCommand(
	...
	virtual ~CShowAddCustomEmoticonDialogCommand();
