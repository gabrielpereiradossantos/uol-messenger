...
class __declspec(novtable) IUOLMessengerIconManager
{
public:
	virtual ~IUOLMessengerIconManager() {}

    virtual void SetAccountIconBaseDir(const CString& strDirPath);
	virtual void SetContactIconBaseDir(const CString& strDirPath);
...
MAKEAUTOPTR(IUOLMessengerIconManager);