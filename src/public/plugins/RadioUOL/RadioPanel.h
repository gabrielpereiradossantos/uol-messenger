...
class CRadioPanel : 
	...
	public CWindowImpl<CRadioPanel>
{
public:
	DECLARE_WND_CLASS("RadioPanel");

	CRadioPanel(const CString& strPanelName, const CString& strPluginInternalName);
