///////////////////////////////////////////////////////////////////////////////
// ExacT Soft (tm) 2001														 //
// Author: Vsevolod Gromov email: pupkinzon@mail.ru; site: pupkinzon.fatal.ru //
...
public:
	...
	//create from bitmap resource\file by name
	bool Create( HINSTANCE hInst, LPCTSTR pszName, BOOL bFile = FALSE );
	...
	//construct from resource\file by name
	CMemBm( HINSTANCE hInst, LPCTSTR pszName, BOOL bFile = FALSE )
	{
		Initialize();
		Create(hInst, pszName, bFile);
	};
