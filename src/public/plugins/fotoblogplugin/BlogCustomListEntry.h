...
class CBlogCustomListEntry : public IUOLMessengerPluginCustomListEntry
{
public:
	CBlogCustomListEntry(const CString& strPluginInternalName, const CString& strEntryName);
	virtual ~CBlogCustomListEntry();
...
class CBlogAction : public IUOLMessengerPluginAction
{
public:
	CBlogAction(const CString& strName);
	virtual ~CBlogAction();
