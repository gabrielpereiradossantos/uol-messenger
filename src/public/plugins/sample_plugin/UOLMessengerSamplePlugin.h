...
class CUOLMessengerSamplePlugin : public CUOLMessengerPlugin,
	CUOLMessengerContactListCtrlObserver
{
public:
	CUOLMessengerSamplePlugin(IUOLMessengerFacade* pUOLMessengerFacade);
	virtual ~CUOLMessengerSamplePlugin(void);
...
private:
	void AddCustomListEntries();
	void RemoveCustomListEntries();
	void AddCustomPanel();
	void RemoveCustomPanel();
	void AddCustomButtons();
	void RemoveCustomButtons();
	void AddCustomButton(IUOLMessengerContactNodePtr pContactNode);
	void RemoveCustomButton(IUOLMessengerContactNodePtr pContactNode);

private:
	IUOLMessengerPluginCustomListEntryPtr	m_pListEntry;
	IUOLMessengerPluginCustomPanelPtr		m_pPanel;
	IUOLMessengerContactListCtrlPtr			m_pContactListCtrl;
	IUOLMessengerUIManager2Ptr				m_pUIManager;
};
