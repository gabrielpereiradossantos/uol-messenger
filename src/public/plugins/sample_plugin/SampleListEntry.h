...
class CSampleListEntry : public IUOLMessengerPluginCustomListEntry
{
public:
	CSampleListEntry(const CString& strEntryName, const CString& strPluginInternalName);
	virtual ~CSampleListEntry();
