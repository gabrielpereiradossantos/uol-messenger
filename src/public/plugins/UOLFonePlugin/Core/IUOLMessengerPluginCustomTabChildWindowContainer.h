...
class __declspec(novtable) IUOLMessengerPluginCustomTabChildWindowContainer
{
public:
	
	virtual ~IUOLMessengerPluginCustomTabChildWindowContainer() {}
	
	virtual IUOLMessengerPluginCustomTabChildWindow* ShowChildWindow(int childWindowID, 
			CUOLFoneChildWindowInfo* pChildWindowInfo) = 0;
	...
	virtual IUOLMessengerPluginCustomTabChildWindow* GetCurrentChildWindow() = 0;
};

MAKEAUTOPTR(IUOLMessengerPluginCustomTabChildWindowContainer);
