...
/////////////////////////////////////////////////////////////////////
// CUOLFoneInitializingStatusPanel
/////////////////////////////////////////////////////////////////////


CUOLFoneInitializingStatusPanel::CUOLFoneInitializingStatusPanel(void)
{
...
void CUOLFoneInitializingStatusPanel::SetStatusString(LPCTSTR statusStr)
{
...
LRESULT CUOLFoneInitializingStatusPanel::OnCreate(
		UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
	...
	labelStr.LoadString(IDS_LABEL_INITIALIZING);
...
LRESULT CUOLFoneInitializingStatusPanel::OnDestroy(
		UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
	m_pictureWnd.UnLoad();
...
/////////////////////////////////////////////////////////////////////
// CUOLFoneInitializingWindow
/////////////////////////////////////////////////////////////////////


CUOLFoneInitializingWindow::CUOLFoneInitializingWindow() : 
...
void CUOLFoneInitializingWindow::GetMinSize(CSize& size)
{
...
void CUOLFoneInitializingWindow::UpdateAccountInfo(CUOLFoneAccountPtr pAccount)
{
}


void CUOLFoneInitializingWindow::UpdatePhoneCallInfo(CPhoneCallPtr pPhoneCall)
{
}


void CUOLFoneInitializingWindow::SetChildWindowInfo(CUOLFoneChildWindowInfo* pChildWindowInfo)
{
...
BOOL CUOLFoneInitializingWindow::CanGetFocus()
{
	return FALSE;
}


void CUOLFoneInitializingWindow::ResetWindow()
{
}


LRESULT CUOLFoneInitializingWindow::OnCreate(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
	//
	// Creating controls...
	//
...
LRESULT CUOLFoneInitializingWindow::OnDestroy(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
...
LRESULT CUOLFoneInitializingWindow::OnSize(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
...
LRESULT CUOLFoneInitializingWindow::OnCtlColor(UINT nMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	HBRUSH hBrush = NULL;
