...
class CUOLFoneRatesWindowFrame : 
	public CWindowImpl<CUOLFoneRatesWindowFrame, CWindow>,
	public IUOLMessengerFrameWindowView,
	public IWebBrowserWindowHolder
								 
{
public:
	CUOLFoneRatesWindowFrame();
	~CUOLFoneRatesWindowFrame();
	BOOL ShouldCancelNavigation(CString strURL);
	BOOL SetUrl(const CString& strUrl);

	BEGIN_MSG_MAP(CUOLFoneRatesWindowFrame)
...
private:
	CWebBrowserWindow		m_tarifasWnd;

};MAKEAUTOPTR(CUOLFoneRatesWindowFrame);