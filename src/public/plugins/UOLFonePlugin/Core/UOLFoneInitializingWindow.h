...
class CUOLFoneInitializingStatusPanel : public CUOLFoneOrganizedColoredPanel
{
public:
	
	CUOLFoneInitializingStatusPanel(void);
	virtual ~CUOLFoneInitializingStatusPanel(void);
	
	void SetStatusString(LPCTSTR statusStr);
	
protected:
	
	BEGIN_MSG_MAP(CUOLFoneInitializingStatusPanel)
...
class CUOLFoneInitializingWindow;

typedef CWinTraits<WS_CHILD | WS_CLIPCHILDREN, WS_EX_TOPMOST> CTopMostControlWinTraits;


class CUOLFoneInitializingWindow : 
		public CWindowImpl<CUOLFoneInitializingWindow, CWindow, CTopMostControlWinTraits>,
...
public:
	...
	CUOLFoneInitializingWindow();
	virtual ~CUOLFoneInitializingWindow();
...
protected:
	...
	BEGIN_MSG_MAP(CUOLFoneInitializingWindow33)
		MESSAGE_HANDLER(WM_CREATE, OnCreate)
		MESSAGE_HANDLER(WM_DESTROY, OnDestroy)
...
private:
	...
	CUOLFoneInitializingStatusPanel		m_statusPanel;
...
MAKEAUTOPTR(CUOLFoneInitializingWindow);
