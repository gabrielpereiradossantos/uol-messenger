...
class CWTLIExplorer : public CWTLAxControl<CWTLIExplorer,IWebBrowser2>
{
	public:
		...
		virtual EVENTFN OnBeforeNavigate2( IDispatch* /*pDisp*/, VARIANT* url, VARIANT* Flags, VARIANT* TargetFrameName, VARIANT* PostData, VARIANT* Headers,  VARIANT_BOOL* Cancel )
		{
			TargetFrameName;
			CString strURL(url->bstrVal);
			ATLTRACE("%s\n",strURL );
			MessageBox( "OnBeforeNavigate2"+strURL );
		}
