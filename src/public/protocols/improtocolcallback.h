...
#ifndef _IM_PROTOCOL_CALLBACK_H_
#define _IM_PROTOCOL_CALLBACK_H_
...
#include "requestuserauthorizationparam.h"
#include "notificationmessageparam.h"
#include "RequestFileTransferAsyncInfo.h"


class CIMProtocolCallback
{
public:
	CIMProtocolCallback();
	virtual ~CIMProtocolCallback();

	virtual unsigned GetCallbackPos();

	void SetPreviousCallback(CIMProtocolCallback* pProtocolCallback);
	CIMProtocolCallback* GetPreviousCallback();
	...
	// OnRequestAddContact callback is deprecated. Now, OnRequestAuthorizeContact is sent instead of OnRequestAddContact
	virtual RequestResult OnRequestAddContact(const std::string& strUser, const std::string& strContact);

	// OnRequestAddUser callback is deprecated. Now, OnRequestAuthorizeContact is sent instead of OnRequestAddUser
...
protected:
	CIMProtocolCallback*	m_pPrev;

	CAutoCriticalSectionWrapper	m_csCallback;
};


class CIMProtocolCallback2 : public CIMProtocolCallback
{
public:
	virtual ~CIMProtocolCallback2();
...
class CIMProtocolCallback3 : public CIMProtocolCallback2
{
public:
	virtual ~CIMProtocolCallback3();
...
class CIMProtocolCallback4 : public CIMProtocolCallback3
{
public:
	virtual ~CIMProtocolCallback4();
...
class CIMProtocolCallback5 : public CIMProtocolCallback4
{
public:
	virtual ~CIMProtocolCallback5();
...
class CIMProtocolCallback6 : public CIMProtocolCallback5
{
public:
	virtual ~CIMProtocolCallback6();
	...
	virtual RequestResult OnRequestAcceptFileAsync(const std::string& strFromUser, const std::string& strContact, CRequestFileTransferAsyncInfo* pFileTransferAsyncInfo);
...
class CIMProtocolCallback7 : public CIMProtocolCallback6
{
public:
	virtual ~CIMProtocolCallback7();
