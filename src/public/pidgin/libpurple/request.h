...
typedef struct
{
	...
	/* UOL << <Added source purpleconnection param> */
	void *(*request_action)(PurpleConnection *pc, const char *title, const char *primary,
	...
	/* UOL << <Added source purpleconnection param> */
	void *(*request_file)(PurpleConnection *pc, const char *title, const char *filename,
