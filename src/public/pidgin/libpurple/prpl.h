...
struct _PurplePluginProtocolInfo
{
	...
	/* UOL <UOL Protocol Extensions> << */
	void (*set_alias)(PurpleConnection *, const char *); // Set user alias on server.
	void* (*get_extensions)(); // Capabilities propagation for Jabber/UOL/UOL-TO.
	/* UOL >> */
