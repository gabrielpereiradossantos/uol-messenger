...
typedef DNS_STATUS (CALLBACK* LPFNDNSQUERYUTF8) (
		PCSTR, WORD, DWORD, PIP4_ARRAY, PDNS_RECORD*, PVOID*);

typedef void (CALLBACK* LPFNDNSRECORDLISTFREE) (
		PDNS_RECORD, DNS_FREE_TYPE);

LPFNDNSQUERYUTF8 MyDnsQuery_UTF8 = NULL;
LPFNDNSRECORDLISTFREE MyDnsRecordListFree = NULL;
