...
static JabberExtensions jabber_extensions = 
{
	sizeof(JabberExtensions),
	jabber_extension_set_presence_pre_send_callback,
	jabber_extension_set_presence_received_callback
};


static void * jabber_extensions_get()
{
	return &jabber_extensions;
}
/* UOL >> */
...
static PurplePluginProtocolInfo prpl_info =
{
	...
	/* UOL << */
	NULL,							/* set_alias */
	jabber_extensions_get,			/* get_extensions */
	/* UOL >> */
...
static PurplePluginInfo info =
{
	...
	DISPLAY_VERSION,                                          /**< version        */
	                                                  /**  summary        */
	/* UOL <UOL Protocol Especific Change> << */
	N_("XMPP TodaOferta Protocol Plugin"),
	                                                  /**  description    */
	N_("XMPP TodaOferta Protocol Plugin"),
