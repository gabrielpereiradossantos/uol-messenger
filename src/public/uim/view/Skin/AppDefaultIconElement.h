...
class CAppDefaultIconElement : public CElement
{
public:
	DECLARE_ELEMENT_NAME("AppDefaultIcon");

	CAppDefaultIconElement();
	virtual ~CAppDefaultIconElement();
...
MAKEAUTOPTR(CAppDefaultIconElement);