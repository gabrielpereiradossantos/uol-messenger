...
//
#include "stdafx.h"
#include "ContactTooltipDialog.h"

CContactTooltipDialog::CContactTooltipDialog()  
{
}
...
LRESULT CContactTooltipDialog::OnInitDialog(HWND hWnd, LPARAM /*lParam*/)
{
...
void CContactTooltipDialog::OnDestroy()
{
}

void CContactTooltipDialog::OnPaint(HDC hDC)
{
	CPaintDC dc(m_hWnd);
