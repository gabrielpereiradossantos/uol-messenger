...
class CPluginCustomGroupMenu : public IUOLMessengerMenuItemCallback
{
public:
	CPluginCustomGroupMenu();
	virtual ~CPluginCustomGroupMenu();
...
MAKEAUTOPTR(CPluginCustomGroupMenu);