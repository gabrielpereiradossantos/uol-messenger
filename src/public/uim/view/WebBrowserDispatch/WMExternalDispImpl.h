...
#ifndef _WM_EXTERNAL_DISP_IMPL_H_
#define _WM_EXTERNAL_DISP_IMPL_H_

#include "IExternalDispImpl.h"


class CWMExternalDispImpl : public CIExternalDispImpl
{
public:
    CWMExternalDispImpl(HWND hHostingWnd);
    ~CWMExternalDispImpl(void);
...
#endif //_WM_EXTERNAL_DISP_IMPL_H_
