...
class CHistoryFrame : public CMainFrame
{
public:
	CHistoryFrame();
	virtual ~CHistoryFrame();

	DECLARE_ELEMENT_NAME("HistoryWindow")
		
	HWND CreateHistoryWindow(HWND hWndParent);
	...
	IUOLMessengerHistoryWindow2* getHistoryWindow();

protected:
	BEGIN_MSG_MAP(CHistoryFrame)
