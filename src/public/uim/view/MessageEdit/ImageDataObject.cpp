...
void CImageDataObject::InsertBitmap(IRichEditOle* pRichEditOle, HBITMAP hBitmap, DWORD dwUserInfo)
{
	InsertBitmap(pRichEditOle, hBitmap, dwUserInfo, NULL);
}

void CImageDataObject::InsertBitmap(IRichEditOle* pRichEditOle, HBITMAP hBitmap, DWORD dwUserInfo, CSize* pHimetricLimitSize)
{
	SCODE sc;
	...
	if (sc != S_OK)
		return; //AfxThrowOleException(sc);
	...
	reobject.sizel = *pHimetricLimitSize;
