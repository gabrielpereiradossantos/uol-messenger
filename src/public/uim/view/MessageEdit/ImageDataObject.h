...
public:
	...
	//
	static void InsertBitmap(IRichEditOle* pRichEditOle, HBITMAP hBitmap, DWORD dwUserInfo);
	static void InsertBitmap(IRichEditOle* pRichEditOle, HBITMAP hBitmap, DWORD dwUserInfo, CSize* pHimetricLimitSize);
