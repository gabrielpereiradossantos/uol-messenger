...
class CGroupChatInviteNode : public CEntryGroup
{
public:
	CGroupChatInviteNode(IUOLMessengerAccountPtr pAccount);
	virtual ~CGroupChatInviteNode();
...
MAKEAUTOPTR(CGroupChatInviteNode);