...
class CGroupReadyForChatNode : public CEntryGroup
{
public:
	CGroupReadyForChatNode(IUOLMessengerAccountPtr pAccount);
	virtual ~CGroupReadyForChatNode();
...
MAKEAUTOPTR(CGroupReadyForChatNode);