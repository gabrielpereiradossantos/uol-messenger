...
#include <interfaces/IUOLMessengerChatNode.h>

class CChatNode : 
	public IUOLMessengerChatNode,
	public GroupListCtrl::CEntry, 
	public CUOLMessengerContactObserver
{
public:
	CChatNode(IUOLMessengerContact3Ptr pContact, const CString& strChatKey);
	virtual ~CChatNode();
	...
	// IUOLMessengerChatNode interface
	virtual IUOLMessengerContact3Ptr GetContact() const;
...
protected:
	...
	virtual void RegisterObserver(CUOLMessengerChatNodeObserver* pObserver);
	virtual void UnregisterObserver(CUOLMessengerChatNodeObserver* pObserver);
...
private:
	...
	void NotifyObservers(void (CUOLMessengerChatNodeObserver::*pfnCallback)(IUOLMessengerChatNode*, IUOLMessengerImageButton2Ptr), IUOLMessengerImageButton2Ptr);
...
private:
	...
	IUOLMessengerContact3Ptr	m_pContact;
	...
	CAtlList<CUOLMessengerChatNodeObserver*> m_listObservers;
