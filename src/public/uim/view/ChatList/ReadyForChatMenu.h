...
class CReadyForChatMenu : public IUOLMessengerMenuItemCallback
{
public:
	CReadyForChatMenu();
	virtual ~CReadyForChatMenu();

	IUOLMessengerContactPtr GetContact();
	BOOL IsBusy() const;

	void CreateMenu(IUOLMessengerContactPtr pContact, IUOLMessengerConversation2Ptr pConversation);
