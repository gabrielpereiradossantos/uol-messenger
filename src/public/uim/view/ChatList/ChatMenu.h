...
class CChatMenu : public IUOLMessengerMenuItemCallback
{
public:
	CChatMenu();
	virtual ~CChatMenu();

	IUOLMessengerContact3Ptr GetContact();
	BOOL IsBusy() const;

	void CreateMenu(IUOLMessengerContact3Ptr pContact);
