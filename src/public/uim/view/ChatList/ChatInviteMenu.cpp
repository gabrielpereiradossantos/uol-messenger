...
CChatInviteMenu::CChatInviteMenu() :
	m_bBusy(FALSE)
{
}
...
IUOLMessengerContactPtr CChatInviteMenu::GetContact()
{
	return m_pContact;
}


BOOL CChatInviteMenu::IsBusy() const
{
	return m_bBusy;
}


void CChatInviteMenu::CreateMenu(IUOLMessengerContactPtr pContact, IUOLMessengerConversation2Ptr pConversation)
{
...
void CChatInviteMenu::ShowMenu(const CPoint& ptPoint)
{
...
void CChatInviteMenu::DestroyMenu()
{
	if (m_pMainMenu != NULL)
	{
...
CContextMenuPtr CChatInviteMenu::GetContextMenu()
{
	return m_pMainMenu;
}


void CChatInviteMenu::OnCommand(IUOLMessengerContextMenuItem* pItem)
{
	if (!m_pContact)
	{
		return;
...
void CChatInviteMenu::CreateContextMenu()
{
	IUOLMessengerAccountPtr pAccount = m_pContact->GetAccount();
...
void CChatInviteMenu::AddItens(CAtlList<IUOLMessengerContextMenuItemPtr>& listItens)
{
...
void CChatInviteMenu::AddSeparator()
{
	m_pMainMenu->AddSeparator();
}