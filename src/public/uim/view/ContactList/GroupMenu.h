...
class CGroupMenu : public IUOLMessengerMenuItemCallback
{
public:
	CGroupMenu();
	virtual ~CGroupMenu();

	IUOLMessengerGroupPtr GetGroup();
	BOOL IsBusy() const;

	void CreateMenu(IUOLMessengerGroupPtr pGroup);
