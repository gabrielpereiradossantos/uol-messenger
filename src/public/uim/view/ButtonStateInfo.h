...
#include <interfaces/IUOLMessengerButtonStateInfo.h>

class CButtonStateInfo : 
	public IUOLMessengerButtonStateInfo,
	public CElement
{
public:
	CButtonStateInfo();
	virtual ~CButtonStateInfo();
