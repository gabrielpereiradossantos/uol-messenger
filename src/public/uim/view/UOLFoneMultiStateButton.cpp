...
void CUOLFoneMultiStateButton::SetMonoStateBitmap(CString strFileName)
{
	if (!m_buttonBitmap.IsNull())
	{
		m_buttonBitmap.DeleteObject();
	...
	m_buttonBitmap = (HBITMAP)::LoadImage(NULL, strFileName, IMAGE_BITMAP, 
...
void CUOLFoneMultiStateButton::SetMultiStateBitmap(CString strFileName)
{
	if (!m_buttonBitmap.IsNull())
	{
		m_buttonBitmap.DeleteObject();
...
void CUOLFoneMultiStateButton::SimulateButtonClick()
{
	...
	// Criar o clock de atualizacao do saldo.
