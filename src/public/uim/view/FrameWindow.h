...
class CFrameWindow : 
	public IUOLMessengerFrameWindow,
	public CMainFrame
{
public:
	CFrameWindow();
	...
	virtual void SetStyle(DWORD dwFrameWindowStyle);
	virtual void SetView(IWindowElementPtr pWindowElement);

	virtual HWND GetHWND() const;

	virtual void SetCaptionText(const CString& strText);
	virtual CString GetCaptionText() const;

	virtual void SetStatusBarText(const CString& strText);
	virtual CString GetStatusBarText() const;
