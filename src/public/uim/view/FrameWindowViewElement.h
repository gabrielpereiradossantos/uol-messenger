...
class CFrameWindowViewElement : 
	public IWindowElement,
	public CElement
{
public:
	CFrameWindowViewElement(IUOLMessengerFrameWindowViewPtr pView);
	virtual ~CFrameWindowViewElement();
...
private:
	IUOLMessengerFrameWindowViewPtr		m_pView;
	CWindow		m_wndView;
	
	CBackgroundElementPtr	m_pWindowBackground;
};

MAKEAUTOPTR(CFrameWindowViewElement);