...
class CWizardInitDialog : public CUOLPropPageImpl
{
public:
    enum { IDD = IDD_DIALOG_WIZARD_INIT };
	DECLARE_ELEMENT_NAME("WizardInitDialog");
...
protected:
	int GetDlgID(){	return IDD_DIALOG_WIZARD_INIT; }
};

MAKEAUTOPTR(CWizardInitDialog);