...
CString CUtility::GetAppFullPathName()
{
	TCHAR szFileName[_MAX_PATH];
	CString strAppFullPathName;
	
	GetModuleFileName(NULL, szFileName, _MAX_FNAME);
	strAppFullPathName = szFileName;
	
	return strAppFullPathName;
}
