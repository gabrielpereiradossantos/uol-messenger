...
class CCommonSettings : public IUOLMessengerCommonSettings,
						public CAccountProtocolSettings
{
public:
	CCommonSettings();
	...
	virtual void SetValue(const CString& strKey, int nValue);
	virtual BOOL GetValue(const CString& strKey, int& nValue) const;

	virtual CString GetAppMode() const;
	virtual void SetAppMode(const CString& strMode);

	virtual CString GetDefaultTheme() const;
	virtual void SetDefaultTheme(const CString& strDefaultTheme);
