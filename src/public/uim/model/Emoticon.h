...
class CEmoticon : public ISettings, public CImageButton
{
public:
	CEmoticon(int nId);
	virtual ~CEmoticon(void);
	...
	void SetSymbol(const CString& strSymbol);
...
protected:
	DECLARE_SETTINGS_CALLBACK(CEmoticon, Symbol);
	DECLARE_SETTINGS_CALLBACK(CEmoticon, Path);
	DECLARE_SETTINGS_CALLBACK(CEmoticon, Name);
