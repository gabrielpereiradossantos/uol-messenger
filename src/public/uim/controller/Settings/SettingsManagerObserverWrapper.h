...
class CSettingsManagerObserverWrapper : public CObserverWrapper<CUOLMessengerSettingsManagerObserver>
{
public:
	CSettingsManagerObserverWrapper(CUOLMessengerSettingsManagerObserver* pObserver);
	virtual ~CSettingsManagerObserverWrapper();
...
MAKEAUTOPTR(CSettingsManagerObserverWrapper);
