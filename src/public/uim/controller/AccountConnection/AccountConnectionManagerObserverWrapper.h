...
class CAccountConnectionManagerObserverWrapper : public CObserverWrapper<CUOLMessengerAccountConnectionManagerObserver>
{
public:
	CAccountConnectionManagerObserverWrapper(CUOLMessengerAccountConnectionManagerObserver* pObserver);
	virtual ~CAccountConnectionManagerObserverWrapper();
...
MAKEAUTOPTR(CAccountConnectionManagerObserverWrapper);