...
class CFileTransferManagerObserverWrapper : public CObserverWrapper<CUOLMessengerFileTransferManagerObserver>
{
public:
	CFileTransferManagerObserverWrapper(CUOLMessengerFileTransferManagerObserver* pObserver);
	virtual ~CFileTransferManagerObserverWrapper();
...
MAKEAUTOPTR(CFileTransferManagerObserverWrapper);