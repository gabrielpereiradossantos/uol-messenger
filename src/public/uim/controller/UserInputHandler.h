...
#include <interfaces/UOLMessengerUserInputHandler.h>


class CUserInputHandler : public CUOLMessengerUserInputHandler3
{
public:
	CUserInputHandler();
	virtual ~CUserInputHandler();
...
protected:
	...
	void AvoidOverridingFilePath(CString& strFilePath);
};
