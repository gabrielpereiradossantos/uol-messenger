...
class CInstallPluginThread : public CMessageLoopThread,
							 public CHttpDownloaderCallback,
							 public CHttpDownloaderStopFlag
{
public:
	CInstallPluginThread(CPluginInfoPtr pPluginInfo);
	virtual ~CInstallPluginThread();
...
MAKEAUTOPTR(CInstallPluginThread);