...
class CProtocolCallbackSelector : public CIMProtocolCallback7
{
public:
	CProtocolCallbackSelector(IUOLMessengerAccountPtr pAccount);
	virtual ~CProtocolCallbackSelector();
	...
	virtual CustomEmoticonAddResult OnCustomSmileyAdd(const std::string& strUser, const std::string& strContact, const std::string& strSmiley, const BOOL bRemote);
	...
	virtual void OnChatContactRenameUser(const std::string& strUser, const int nChatId, const std::string& strChatContactOldName, const std::string& strChatContactNewName, const std::string& strChatContactNewAlias);
	virtual void OnChatRemoveUser(const std::string& strUser, const int nChatId, const std::string& strChatContactName);
	virtual void OnChatContactUpdateUser(const std::string& strUser, const int nChatId, const std::string& strChatContactName, const std::string& strChatContactAlias, const int bIsContact);
...
MAKEAUTOPTR(CProtocolCallbackSelector);